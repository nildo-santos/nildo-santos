<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&speed=50&pause=2000&repeat=true&color=F2CDCD&center=true&width=1000&lines=Ol%C3%A1!+Sou+Nildo+Santos+%F0%9F%91%8B;Desenvolvedor+Full-Stack+Java+.Net+%7C+APIs+RESTful;Arquitetura+de+Sistemas+Web" alt="Typing SVG" />
</p>

---

### 🚀 Sobre Mim
Sou **Nildo Santos**, Desenvolvedor Full Stack especializado em **.NET** e **Java**.  
Apaixonado por tecnologia, **APIs RESTful**, **Arquitetura de Sistemas Web** e **Bancos de Dados SQL & NoSQL**.  
Busco sempre criar soluções escaláveis, seguras e de alta qualidade.
---
...
- 🎓 Análise e Desenvolvimento de Sistemas (ADS)
  - *Foco: Análise de Software Full Stack*

**COTI Informática**
- ☕ Formação Java Web Developer (Full Stack)
- 🔷 Formação C# .NET Developer (Full Stack)
- 🗄️ Banco de Dados
- 🏆 **Conquista:** 1º Lugar no Hackathon 2025 (Coti Informática & Criare Sistemas) com a equipe Javangers.
